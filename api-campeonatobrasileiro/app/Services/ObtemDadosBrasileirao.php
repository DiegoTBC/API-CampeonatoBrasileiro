...
class ObtemDadosBrasileirao
{
    ...
    {
        return self::percorreDadosERetornaJson("https://www.terra.com.br/esportes/futebol/brasileiro-serie-a/tabela/");
    }

    static public function serieB()
    {
        return self::percorreDadosERetornaJson("https://www.terra.com.br/esportes/futebol/brasileiro-serie-b/tabela/");
    }

    static private function percorreDadosERetornaJson(string $site)
    {
        $client = \Symfony\Component\HttpClient\HttpClient::create();
        $browser = new \Symfony\Component\BrowserKit\HttpBrowser($client);
        $crawler = $browser->request("GET", $site);
